...
public class LocomotionTeleport : MonoBehaviour
{
	...
	{
			if(LocomotionController.weaponControllerManager != null)
			{
				LocomotionController.weaponControllerManager.canChangeWeapon = true;
			}
	...
	protected IEnumerator AimStateCoroutine()
	{
		...
		if ((CurrentIntention == TeleportIntentions.PreTeleport || CurrentIntention == TeleportIntentions.Teleport) && _teleportDestination.IsValidDestination)
		{
					if(LocomotionController.weaponControllerManager != null)
					{
						LocomotionController.weaponControllerManager.canChangeWeapon = false;
					}
